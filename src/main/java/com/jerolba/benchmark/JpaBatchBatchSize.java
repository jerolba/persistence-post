...
/*
 * Persist all information in PostgreSQL or MySQL using JPA batched inserts using autoincremental Id.
 */
public class JpaBatchBatchSize {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        BenchmarkMeter meter = new BenchmarkMeter(JpaBatchBatchSize.class, properties, batchSize);
